package encapsulation.ShoppingSpare;
        ...
        try {
            ...
            for (Person person : persons.values()) {
                if (person.getProducts().isEmpty()) {
                    ...
                    builder.append(person.getProducts().get(0).getName());
                    for (int i = 1; i < person.getProducts().size(); i++){
                        builder.append(String.format(", %s", person.getProducts().get(i).getName()));
                    }
