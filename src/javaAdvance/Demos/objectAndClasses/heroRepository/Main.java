...
//Add Heroes
     ...
     Hero heroAbility = repository.getHeroWithHighestAgility(); //returns inheritance.hero
     Hero heroIntelligence = repository.getHeroWithHighestIntelligence(); //returns inheritance.hero
//
