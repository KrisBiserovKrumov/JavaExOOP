...
public class OutputMessages {
    ...
    public static final String fighterManufactured = "FighterImpl %s manufactured - attack: %.2f; defense: %.2f";
    ...
    public static final String fighterOperationSuccessful = "FighterImpl %s toggled aggressive mode";
